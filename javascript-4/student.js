...
// CODE HERE
let faveColors = ["black", "navy", "orange"];
...
//The next variable is 'superName' which is the value of superHeroName on the me object.
//Last is 'homeTown' which will be the value of homeTown on the me object
...
// Next, create a for loop to loop over the array.
// If any of the colors you chose is 'blue', change it's value to '#4D4DFF' which is just a more appealing color of blue.
...
//These arguments should be each item of your array. This is a function we created for you to set the background colors.
